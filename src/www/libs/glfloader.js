    ...
    extendParams(materialParams, materialDef, parser) {
        ...
        if (metallicRoughness) {
            ...
            if (metallicRoughness.baseColorTexture !== undefined) {
                pending.push(
                    parser.assignTexture(materialParams, "map", metallicRoughness.baseColorTexture, sRGBEncoding)
                );
            }
        }
...
class GLTFMaterialsSheenExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
        ...
        if (extension.sheenColorTexture !== undefined) {
            pending.push(
                parser.assignTexture(materialParams, "sheenColorMap", extension.sheenColorTexture, sRGBEncoding)
            );
        }
...
class GLTFParser {
    ...
    loadMaterial(materialIndex) {
        ...
        if (materialDef.emissiveTexture !== undefined && materialType !== MeshBasicMaterial) {
            pending.push(
                parser.assignTexture(materialParams, "emissiveMap", materialDef.emissiveTexture, sRGBEncoding)
            );
        }
    ...
    loadAnimation(animationIndex) {
        ...
        for (let i = 0, il = animationDef.channels.length; i < il; i++) {
            ...
            const input =
                animationDef.parameters !== undefined ? animationDef.parameters[sampler.input] : sampler.input;
            const output =
